...
function P835OvlPage(_pageManager, _audioContext, _bufferSize, _audioFileLoader, _session, _pageConfig, _mushraValidator, _errorHandler, _language) {
  this.isMushra = true;
...
P835OvlPage.prototype.getName = function () {
  return this.pageConfig.name;
};

P835OvlPage.prototype.init = function () {
  var toDisable;
  var td;
  var active;
...
P835OvlPage.prototype.render = function (_parent) {
  var div = $("<div></div>");
  _parent.append(div);
  var content;
...
P835OvlPage.prototype.pause = function () {
  this.mushraAudioControl.pause();
};

P835OvlPage.prototype.setLoopStart = function () {
...
P835OvlPage.prototype.setLoopEnd = function () {
  var slider = document.getElementById('slider');
...
P835OvlPage.prototype.btnCallbackReference = function () {
...
P835OvlPage.prototype.surpressLoop = function () {
...
P835OvlPage.prototype.btnCallbackCondition = function (_index) {
...
P835OvlPage.prototype.renderCanvas = function (_parentId) {
  ...
  var xLetters = $("#refCanvas").width() + ($("#spaceForScale").width() + canvasContext.measureText(this.pageManager.getLocalizer().getFragment(this.language, 'excellent') + "    3").width) / 1.5;

  canvasContext.fillText(this.pageManager.getLocalizer().getFragment(this.language, 'excellent') + "    5", xLetters, YfirstLine);
  canvasContext.fillText(this.pageManager.getLocalizer().getFragment(this.language, 'good') + "    4", xLetters, prevScalesHeight * 0.25 + YfirstLine);
  canvasContext.fillText(this.pageManager.getLocalizer().getFragment(this.language, 'fair') + "    3", xLetters, prevScalesHeight * 0.5 + YfirstLine);
  canvasContext.fillText(this.pageManager.getLocalizer().getFragment(this.language, 'poort') + "    2", xLetters, prevScalesHeight * 0.75 + YfirstLine);
  canvasContext.fillText(this.pageManager.getLocalizer().getFragment(this.language, 'bad') + "    1", xLetters, prevScalesHeight + YfirstLine);

};


P835OvlPage.prototype.load = function () {
...
P835OvlPage.prototype.save = function () {
  this.macic.unbind();
...
P835OvlPage.prototype.store = function () {
