...
function P835SigPage(_pageManager, _audioContext, _bufferSize, _audioFileLoader, _session, _pageConfig, _mushraValidator, _errorHandler, _language) {
  this.isMushra = true;
...
P835SigPage.prototype.getName = function () {
  return this.pageConfig.name;
};

P835SigPage.prototype.init = function () {
  var toDisable;
  var td;
  var active;
...
P835SigPage.prototype.render = function (_parent) {
  var div = $("<div></div>");
  _parent.append(div);
  var content;
...
P835SigPage.prototype.pause = function () {
  this.mushraAudioControl.pause();
};

P835SigPage.prototype.setLoopStart = function () {
...
P835SigPage.prototype.setLoopEnd = function () {
  var slider = document.getElementById('slider');
...
P835SigPage.prototype.btnCallbackReference = function () {
...
P835SigPage.prototype.surpressLoop = function () {
...
P835SigPage.prototype.btnCallbackCondition = function (_index) {
...
P835SigPage.prototype.renderCanvas = function (_parentId) {
  ...
  var xLetters = $("#refCanvas").width() + ($("#spaceForScale").width() + canvasContext.measureText(this.pageManager.getLocalizer().getFragment(this.language, 'distorted3') + "    3").width) / 2.0;

  canvasContext.fillText(this.pageManager.getLocalizer().getFragment(this.language, 'distorted5') + "    5", xLetters, YfirstLine);
  canvasContext.fillText(this.pageManager.getLocalizer().getFragment(this.language, 'distorted4') + "    4", xLetters, prevScalesHeight * 0.25 + YfirstLine);
  canvasContext.fillText(this.pageManager.getLocalizer().getFragment(this.language, 'distorted3') + "    3", xLetters, prevScalesHeight * 0.5 + YfirstLine);
  canvasContext.fillText(this.pageManager.getLocalizer().getFragment(this.language, 'distorted2') + "    2", xLetters, prevScalesHeight * 0.75 + YfirstLine);
  canvasContext.fillText(this.pageManager.getLocalizer().getFragment(this.language, 'distorted1') + "    1", xLetters, prevScalesHeight + YfirstLine);

};


P835SigPage.prototype.load = function () {
...
P835SigPage.prototype.save = function () {
  this.macic.unbind();
...
P835SigPage.prototype.store = function () {
