...
FinishPage.prototype.render = function (_parent) {
  ...
  if (this.pageConfig.showResults) {
    ...
    for (i = 0; i < trials.length; ++i) {
      ...
      if (trial.type === "mushra") {
      ...
      } else if (trial.type === "p835sig") {
        trT = document.createElement("tr");
        thT = $("<th colspan='2'></th>");
        $(thT).append(trial.id + " (P.835 SIG)");
        $(trT).append(thT);
        $(table).append(trT);
        ...
        trEmpty = $("<tr height='8px'></tr>");
        $(table).append(trEmpty);
      } else if (trial.type === "p835bak") {
        trT = document.createElement("tr");
        thT = $("<th colspan='2'></th>");
        $(thT).append(trial.id + " (P.835 BAK)");
        $(trT).append(thT);
        $(table).append(trT);
        ...
        trEmpty = $("<tr height='8px'></tr>");
        $(table).append(trEmpty);
      } else if (trial.type === "p835ovl") {
        trT = document.createElement("tr");
        thT = $("<th colspan='2'></th>");
        $(thT).append(trial.id + " (P.835 OVL)");
        $(trT).append(thT);
        $(table).append(trT);
